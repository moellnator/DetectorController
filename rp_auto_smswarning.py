...
class SmsWarning:
    ...
    def __init__( self, name, modem, recipients, suppress ):
        ...
        self.logger = logging.getLogger('rp_auto_ctrl')   # tie into the global rp_auto_ctrl logger -- \ch: unfortunately this means that logging messages have 'SmsWarning' as module descriptor
    ...
    def Send( self, message ):
        ...
        self.logger.warning('WARN[' + name + ']: ' + message)
